const Donate = () => {
  const paymentMethods = [
    { name: 'Cash App', handle: '$POWRDesign', icon: '💵' },
    { name: 'Venmo', handle: '@JTBPhoenix', icon: '💳' },
    { name: 'PayPal', handle: 'terranovare42@gmail.com', icon: '🅿️' },
    { name: 'Apple Pay', handle: 'Available', icon: '🍎' }
  ]
